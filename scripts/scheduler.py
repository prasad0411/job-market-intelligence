...
JOBS = [
    ...
    # send_scheduled runs in GitHub Actions only (send_emails.yml). Two
    # schedulers against one sheet raced for the same rows; the runner is
    # always on, this Mac is not.
